...
buttons[0] = instance_create(room_width /2, (room_height/2)-(1*manager.gap_button), obj_button_music);
buttons[1] = instance_create(room_width /2, (room_height/2)+(1*manager.gap_button), obj_button_tutorial);
