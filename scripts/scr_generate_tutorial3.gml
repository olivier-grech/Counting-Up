...
add_buttons[1] = instance_create((room_width/2) - 3*(manager.small_button_width*manager.small_button_stretch + manager.small_button_gap), (room_height/2)- manager.small_button_height*manager.small_button_stretch - manager.small_button_gap, obj_indicator3_tutorial);
